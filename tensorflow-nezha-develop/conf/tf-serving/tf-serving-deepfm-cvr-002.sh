...
# 指定Kubeflow的版本
VERSION=v0.2.0-rc.0
APP_NAME=tf-serving-deepfm-cvr-002
...
MODEL_COMPONENT=tf-serving-deepfm-cvr-002
MODEL_NAME=deepfm-cvr-002
MODEL_PATH=/mnt/serving-model/${MODEL_NAME}
MODEL_STORAGE_TYPE=nfs
SERVING_PVC_NAME=pvc-${MODEL_NAME}
...
ks apply ack -c tf-serving-${MODEL_NAME}