...
# 指定Kubeflow的版本
VERSION=v0.2.0-rc.0
APP_NAME=tf-serving-deepfm-ctr-001
...
MODEL_COMPONENT=tf-serving-deepfm-ctr-001
MODEL_NAME=deepfm-ctr-001
MODEL_PATH=/mnt/serving-model/deepfm-ctr-001
MODEL_STORAGE_TYPE=nfs
SERVING_PVC_NAME=pvc-deepfm-ctr-001
...
ks apply ack -c tf-serving-deepfm-ctr-001