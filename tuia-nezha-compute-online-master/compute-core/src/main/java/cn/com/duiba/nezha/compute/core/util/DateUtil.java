...
import cn.com.duiba.nezha.compute.core.enums.Week;
...
public class DateUtil {
    ...
    public static Integer getIntervalSeconds(String date, String otherDate, DateStyle dateStyle) {

        Integer hours = null;
        if(date!=null && otherDate!=null && dateStyle!=null){
            hours = getIntervalSeconds(StringToDate(date, dateStyle), StringToDate(otherDate, dateStyle));
        }
        return hours;
    }
     ...
     * @return 相差小时数
     */
    public static Integer getIntervalSeconds(Date date, Date otherDate) {
        Integer ret =null;
        if(date!=null && otherDate!=null){
            long time = Math.abs(date.getTime() - otherDate.getTime());
            ret = (int) (time / (1000));
