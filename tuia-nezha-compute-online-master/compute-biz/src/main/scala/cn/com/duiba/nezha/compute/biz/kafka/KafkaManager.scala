package cn.com.duiba.nezha.compute.biz.kafka

import cn.com.duiba.nezha.compute.biz.kafka.KafkaCluster.LeaderOffset
...
class KafkaManager(val kafkaParams: Map[String, String]) extends Serializable {
   ...
   * @return
   */
  def createDirectStreamWithOffSet[K: ClassTag, V: ClassTag, KD <: Decoder[K] : ClassTag, VD <: Decoder[V] : ClassTag](
                                                                                                                        ssc: StreamingContext, kafkaParams: Map[String, String], topics: Set[String]): InputDStream[(K, V)] = {
